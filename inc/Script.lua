...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/abazaa/clayFILE/master/GetVersion.txt' ) or 0
...
return 'ٴ𐄬 اصدار سورس كلاي : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'•☆ ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس كلاي يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
send_key(msg.sender_user_id_,'   [قناة سورس : كلاي](https://t.me/tamer_hosni)' ,nil,inline,msg.id_)
return false
end
...
༆-[𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑✫](t.me/Bahjat100)

༆-[𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑✫](t.me/ali_wekaaaa)

༆-[𝐂𝐇𝐀𝐍𝐍𝐄𝐋 𝐙𝐎𝐑𝐎✫](t.me/SOURCE_clay) 

༆-[𝐈𝐍𝐅𝐎𝐑𝐌𝐀𝐓𝐈𝐎𝐍✫](t.me/xb_1b)

༆-[𝐓𝐎 𝐓𝐀𝐋𝐊 𝐓𝐎 𝐔𝐒✫](t.me/Tawasl_clay_bot)
]]
end
...
ـــــــــــــــــــــــــــــــــclayــــــــــــــــــــــــ
 • مـعـرف الـمـطـــور : ]]..SUDO_USER..[[
]]
end
...
local NUM_MSG_clay = (redis:get(clay..'num_msg_clay'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_clay) then 
...
SendMention(msg.chat_id_,datau.id_,msg.id_,"• العضو » "..USERNAME.."\n• قمـت بتكرار اكثر مـن "..NUM_MSG_clay.." رسالة‌‏ , لذا تم تقييدك مـن المجموعه‌\n",12,USERCAR) 
return false
end)
end 
...
elseif Text== "ندي" or Text== "nada" then return  sendMsg(msg.chat_id_,msg.id_,"[بيست الجوكر و قمر التلي](https://t.me/Alsenyorita)")
elseif Text== "hadeer" or Text== "هدير" then return  sendMsg(msg.chat_id_,msg.id_,"[قلبو لجوكر راب](https://t.me/ddiirroo)")
...
ٴ≪━━━━━clay━━━━━≫ٴ
 ...
 ✸ رابط حذف [Snspchat](https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount) ܁
  ...
  --=====================================
  elseif Text== "يوسف" or Text== " اباظه " or Text=="basel abaza" then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس.](https://t.me/AV_ZX) ")
