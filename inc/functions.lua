...
MsgShow = 'تفاعل يخلي الواحد ينشكح .'
...
clay..'num_msg_clay'..msg.chat_id_,5, 
...
.."\n• عدد التكرار «» "..(redis:get(clay..'num_msg_clay'..msg.chat_id_) or 'false')
