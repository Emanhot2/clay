--[[
الالعاب ل سورس سيلا
تم تعديل الملف واضافه الالعاب من قبل فارس (@JOKERRAP1)
--]]
...
return '- اول من يكتب هذه العدد يفوز ؛  ››`'..(redis:get(clay..':Set_Smile:'..msg.chat_id_))..'`'
else
return '️- اول من يكتب هذه السمايل يفوز ››    `'..(redis:get(clay..':Set_Smile:'..msg.chat_id_))..'`'
end
end
...
redis:set(clay.."GAME:CHER"..msg.chat_id_,'مو جبان') 
elseif SENDTEXT:find('عدل') then
redis:set(clay.."GAME:CHER"..msg.chat_id_,'عدل') 
elseif SENDTEXT:find('نشط') then
redis:set(clay.."GAME:CHER"..msg.chat_id_,'نشط') 
...
redis:set(clay.."GAME:CHER"..msg.chat_id_,'مو مسموح') 
